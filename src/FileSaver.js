(function (root, factory) {
  ...
  return function () {
    ...
    var saveAs = (function (view) {
      ...
      if (navigator !== undefined && /MSIE [1-9]\./.test(navigator.userAgent)) {
        return;
      }

      // IE 10+ (native saveAs)
      if (navigator !== undefined && navigator.msSaveOrOpenBlob) {
      ...
      var saveLinkElement = doc.createElementNS("http://www.w3.org/1999/xhtml", "a");
